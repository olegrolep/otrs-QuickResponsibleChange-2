# --
# Kernel/Output/HTML/TicketOverviewMenu/QuickResponsibleChangeBulk.pm
...
package Kernel::Output::HTML::TicketOverviewMenu::QuickResponsibleChangeBulk;
...
sub Run {
    ...
    $ReturnData{HTML} = $LayoutObject->Output(
        TemplateFile => 'QuickResponsibleChangeSnippetBulk',
        Data         => {
